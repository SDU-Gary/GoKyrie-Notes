...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%201.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%202.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%203.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%204.png)

### CMYK

以红、绿、蓝的补色**青(Cyan)、洋红(Magenta)、黄(Yellow)**为原色构成的CMYK颜色模型，常用于从白光中滤去某种颜色，又被称为减性原色系统。

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%205.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%206.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%207.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%208.png)
...
1. 方案1：使用了基于delta值的z轴转换矩阵作用于月球的各个顶点上。其中，各delta值表示一帧内移动的角度值(步进)
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%209.png)

2. 方案2：不断调整转换矩阵， 并使对象空间顶点转换至世界空间位置。

    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2010.png)

3. 将向累积角变量添加delta值， 且根据角参数构造z轴旋转矩阵，并于随后
与x轴转换矩阵执行乘法操作，结果矩阵将作用于对象空间内的原月球顶点上

    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2011.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2012.png)

参数空间中每一个t对应于曲线上一个点Q(t),图形学中，参数空间通常是有限区间，此时参数曲线称为参数曲线段

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2013.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2014.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2015.png)

根据这四个约束条件进行求解，得到Hermite曲线定义

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2016.png)

例:假设小球在t=0和t=1时刻的位置分别为(1,4,5)和(3,1,4)，沿x,y,z轴的速度分别为(2,3,1)和(1,1,1)，请（根据hermite曲线公式）写出小球在t=0.5时刻的位置和速度.

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2017.png)
...
- 另外两个控制点（用于间接指定P1和P4处的切向量R1和R4）
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2018.png)
    

根据这四个约束条件进行求解，得到Bézier曲线定义

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2019.png)

### Bernstein多项式

Bernstein多项式的定义（代入n=3得到Bézier曲线的基矩阵）:

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2020.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2021.png)

例:假设Bézier曲线的在t=0,0.3,0.5,1时刻分别经过(30,0),(54.3,11.7),(67.5,22.5),(90,60)，请给出该曲线的四个控制点。(给位置找控制点)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2022.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2023.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2024.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2025.png)

其实可以算一种微分,用极小距离之间的线性距离代替弧长.

例:

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2026.png)
...
- v正交于w且为二阶导数方向(P''(u))
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2027.png)
    

例:

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2028.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2029.png)

问题1:谁动:偏移某一顶点（种子顶点）或者该对象的顶点组

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2030.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2031.png)
...
- 按顶点之间沿曲面的距离:d=测地距离
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2032.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2033.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2034.png)
...
- 基于**点**的变形
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/Indirect_Deformation_Technology.png)
...
1. 创建变形工具
    ...
    2. 均匀划分x,y形成网格
        ...
        ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2035.png)
...
3. 移动变形工具的顶点
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2036.png)
...
4. 改变目标物体的形状
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2037.png)
    

双线性插值计算过程需要现在原始状态下计算出插值权重,沿用该权重到新的空间中

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2038.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2039.png)
...
2. 建立约束关系
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2040.png)
    
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2041.png)
...
4. 改变目标物体的形状
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2042.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2043.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2044.png)

**基于网格的Morphing**

为了实现图像之间的彼此转换,可在两幅图像中定义一个曲线网络.用户负责定义网络,即在两幅图像中制定同等数量的网格

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2045.png)
...
3. 在两幅图像之间实施过渡
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/1f82abb7-00c0-495e-a050-83622550be5a.png)
    

每一步中间帧图像可以经历下面四个步骤来生成:

1. 线性插值网络$M_S$和$M_D$,得到网格$M$
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2046.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2047.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2048.png)

如何合并两个模型的拓扑结构？星形物体，是指物体中至少有一点，从该点可见多面体的所有顶点。显然，凸体是星形物体的特例，而星形物体则可以是凹体。

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2049.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2050.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2051.png)
...
- 移动关节(Prismatic Joint)
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2052.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2053.png)
...
- 连接弧——表示层次结构中应用与物体部件之间的关节或变换
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2054.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2055.png)

对该结构进行旋转变换:

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2056.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2057.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2058.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2059.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2060.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2061.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2062.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2063.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2064.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2065.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2066.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2067.png)
...
- 对于每一步k, 通过上述公式得到关节的角速度 ，然后执行
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2068.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2069.png)

### 顶点混合

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2070.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2071.png)

### 线性混合蒙皮

对每个顶点来说，其被绑定到的每个关节对他的影响程度不同，设定每个关节的权重，就可以通过加权算出顶点受这些关节共同影响后的位置.

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2072.png)
...
- 如果顶点受到>=3个骨骼的影响，其权因子$w_i$可根据顶点到骨骼的距离来决定
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2073.png)
    

但这样也不是没有问题.当某些关节旋转到一些极端角的时候,网格模型的体积会损失,这个叫做”关节塌陷”或”糖果包裹”

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2074.png)

关节塌陷的原因:

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2075.png)

解决办法：把球面线性插值取代上述公式中的线性插值(四元数插值）

或者可以添加修改骨骼(实际上是将真实骨骼的体积性质表现出来)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2076.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2077.png)

那么如何从多边形模型中自动计算出骨架呢?可以利用物体的中轴,或者通过球体拟合来计算

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2078.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2079.png)

离散骨架嵌入:从给定的骨架模型建立一个简化的骨架，该骨架包含原骨架的端点和分叉关节点,把简化的骨架拟合到角色图(Character graph)中,使离散惩罚函数最小化，得到一个嵌入的骨架，再进行优化

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2080.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2081.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2082.png)

### 电磁运动捕获

和光学系统工作原理类似，但电磁运动捕捉系统是将传感器绑定到角色四肢上，传感器可以在低频磁场中测量传感器的位置和朝向。优点是除了传感器的位置信息以外，还可以得到朝向信息，可以很方便地应用到实时运动捕捉中。

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2083.png)

### 视觉运动捕捉系统

视觉运动捕捉技术是一种通过计算机视觉技术，从输入图像或视频中检测并识别出人体的关键点，进而推断出人体的姿态信息的技术。

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2084.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2085.png)
...
- 如果运动是相近的，则很容易
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2086.png)
    
- 如果运动相差较远，则比较困难
    
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2087.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2088.png)
...
3. 移走:不在视域。
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2089.png)
...
- 把每个粒子当成一个点光源
    ...
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2090.png)
    
- 把每个粒子建模为一个带纹理的广告牌(textured billboard)
    - 纹理多边形面向视点
    
    ![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2091.png)
    
- 把每个粒子看成元球，绘制整个元球系统(用于模拟水等液态效果):元球相互靠近到一定距离产生变形，再进一步靠近时则融合成光滑表面.

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2092.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2093.png)

对重力数值积分算法:

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2094.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2095.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2096.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2097.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2098.png)

然后使用一系列微分方程描述这个过程

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%2099.png)

### 粒子系统模拟的例子

**瀑布模拟**

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%20100.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%20101.png)

瀑布粒子的碰撞检测：瀑布在下落的过程中将会与大量的障碍物进行碰撞形成水花飞溅的现象。为了模拟这种效果，在粒子和障碍物之间须进行碰撞检测。

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%20102.png)
...
![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%20103.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%20104.png)

![image](http://107.173.55.162:40070/apps/sharingpath/Kyrie/public/ComputeAnimation/images/image%20105.png)